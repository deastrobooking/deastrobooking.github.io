$( document ).ready( function() {
    ...
    $("#repo").click(function()
    {
      ...
      $( '#result' ).html( "" );
      $.ajax({
        url:"https://api.github.com/repos/deastrobooking/Bootstrap-Select-Box",
        dataType: "jsonp",
  ...
  function get_watched_repos() 
  {
    ...
    $.ajax( {
          url : "https://api.github.com/users/deastrobooking/watched",
          dataType : "jsonp",
          success : function ( returndata ) {
...
// reference 
  //https://codepen.io/bvasko/pen/ALYqQx
