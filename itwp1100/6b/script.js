...
function validateRequired() {
    ...
    try {
        for (var i = 0; i < elementCount; i++) { // validate all required input elements in fieldset 
        ...
        if (!crustBoxes[0].checked && !crustBoxes[1].checked) { // verify that a crust is selected
...
function removeSelectDefault() {
    ...
    selectBox.selectedIndex = -1; selectBox.style.boxShadow = "none";
}
