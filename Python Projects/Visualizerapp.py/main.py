...
# Needs work on condition state. Needs GUI. Program doesn't like to run repeatedly so I suggest finding a way to maintain a photo that is updated by the random generation. 
